...
public class UpdateStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String json = SharedPrefUtil.getInstance(UpdateStatus.this).getString("data_input");
        ...
        absentAdd.enqueue(new Callback<UpdateModel>() {
            ...
            public void onResponse(Call<UpdateModel> call, Response<UpdateModel> response) {
                ...
                if (status != null) {
                    ...
                    if (status.getStatus()) {
                        Toast.makeText(UpdateStatus.this, "Update status Berhasil", Toast.LENGTH_LONG).show();

                        Gson gson = new Gson();
                        String json = gson.toJson(status.getData());
                        SharedPrefUtil.getInstance(UpdateStatus.this).put("data_input", json);
                    ...
                    try {
                        ...
                        Toast.makeText(UpdateStatus.this, error, Toast.LENGTH_LONG).show();

                    } catch (Exception e) {
                        try {
                            Toast.makeText(UpdateStatus.this, "Send Failed, " + response.errorBody().string(), Toast.LENGTH_LONG).show();

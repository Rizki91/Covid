...
public class Covid implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = 1980105820520135384L;
    ...
    protected Covid(Parcel in) {
        ...
        this.timestmap = ((String) in.readValue((String.class.getClassLoader())));
